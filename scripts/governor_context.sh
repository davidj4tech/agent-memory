...
print()
print("> To search long-term memory on demand, run `agent-memory-search <query> [user_id] [limit]` (or legacy `sacred-search`). Defaults: `user_id=sam`, `limit=5`. Use `user_id=david` for memories distilled from ChatGPT history. See `docs/SACRED_SEARCH.md` in the sacred-brain repo.")
print()
if not results:
