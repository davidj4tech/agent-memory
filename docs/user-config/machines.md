...
| p8a | 100.94.14.59 | u0_a2 (Termux) | `http://100.125.48.108:54321` | `sam` |
...
- **p8a** (phone, Termux) runs on port 8022 for SSH but the Hippocampus URL is the same as other remotes — it reaches homer outbound over Tailscale.
